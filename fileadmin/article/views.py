...
from .models import Article, Slogan
from .constraint import SLUG_DIR, SUB_SLUG_DIR, TEMPLATE_PAGE_NAME
...
def page_or_404(name):
    ...
    """
    try:
        file_path = safe_join(settings.BASE_DIR, 'article', 'templates', name)
    except ValueError:
